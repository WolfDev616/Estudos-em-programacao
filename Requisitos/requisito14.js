...
function categorizeExpenses(array) {
    let typeOfExpenseArray = Array.from(array)
    for (i=0;i<array.length;i++) {
        if (array[i] < 100) {
            typeOfExpenseArray[i] = "Controled expense"
        } else {
            typeOfExpenseArray[i] = "High expense"
        }
    }
    console.log(typeOfExpenseArray)
}

categorizeExpenses(numbersExpenses)

console.log(numbersExpenses)
